    ...
    return ReactDOM.createPortal(
      <div className='fixed top-0 left-0 z-[999] w-full p-4 overflow-x-hidden overflow-y-auto h-full flex justify-center items-center'>
        <div className='relative z-2 max-w-2xl md:h-auto flex justify-center max-h-full'>
          <div className='relative bg-gray-800 rounded-lg shadow max-h-full overflow-y-auto hide-scroll-bar'>
            <div className='flex items-center justify-between p-4 border-b rounded-t border-gray-600'>
              ...
              <button
                type='button'
                className='text-gray-400 hover:bg-gray-700 hover:text-white rounded-lg text-sm p-1.5 ml-auto inline-flex items-center'
            ...
            {message && (
              <div className='p-6 border-b border-gray-600 bg-gray-800'>
                <div className='min-w-fit text-gray-300 text-sm mt-4'>
                  {message}
                </div>
              </div>
            )}
            ...
            <div className='flex items-center justify-center p-6 gap-4 bg-gray-800'>
              {handleConfirm && (
                <button
                  type='button'
        ...
        <div
          className='bg-black/75 absolute top-0 left-0 h-full w-full z-[-1]'
